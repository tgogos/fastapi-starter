...
- Auth direction: browser session + CSRF; API Bearer opaque tokens in SQLite; protected JSON accepts session or Bearer. Do not default to JWT or OAuth unless `ENGINEERING.md` says so.
